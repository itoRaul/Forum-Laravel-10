        ...
        <div class="relative flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div class="space-y-4">
                <div class="flex items-center gap-2">
                    <span class="rounded-full bg-indigo-50 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.24em] text-indigo-600">Novo tópico</span>
                ...
                <div class="space-y-2">
                    <h1 class="text-3xl font-black tracking-tight text-gray-900 sm:text-4xl">
                        Cadastrar <span class="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">Dúvida</span>
                    </h1>
                </div>
            </div>
...
@section('content')
    <div class="mx-auto max-w-3xl">
        <form action="{{ route('forum.store') }}" method="POST" class="overflow-hidden rounded-3xl border border-gray-100 bg-white shadow-xl shadow-gray-200/40">
            @csrf
            ...
            <div class="border-b border-gray-100 px-6 py-5 sm:px-8">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-lg font-bold text-gray-900">Detalhes da dúvida</h2>
                        <p class="text-sm text-gray-500">Preencha os campos abaixo para publicar o tópico.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="px-6 py-6 sm:px-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex flex-col gap-3 border-t border-gray-100 pt-6 sm:flex-row sm:items-center sm:justify-between">
                        <p class="text-sm text-gray-500">Depois de publicar, o tópico ficará disponível no fórum.</p>
